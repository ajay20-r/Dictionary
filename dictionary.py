...
def fetching(entry):
	...
	for j in dis:
		for k in j:
			final.append(k)
	#DISPLAY OUTPUT________________________________
	for x in final:
		label=Label(frame2,text=x,font=("calibri",18,'bold'))
		label.pack()

#USER INTERFACE_______________________________________________________
root=Tk()
...
#OUTPUT LABEL____________________________________________________________
